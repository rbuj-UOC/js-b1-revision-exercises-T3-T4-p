...
> 💡 El ejercicio deberás realizarlo en el fichero correspondiente, que estará ubicado en la carpeta del bloque de ejercicios de repaso y con la nomenclatura **T3-T4.js**. El ejercicio se presentará en un fichero js, que incluirá un comentario con el enunciado del ejercicio.

El EJERCICIO DE REPASO es el siguiente:

| UNIDAD                       | Ejercicios              |
| ---------------------------- | ----------------------- |
| 1. EJERCICIO TEMA 3 y TEMA 4 | [T3-T4](T3-T4/T3-T4.js) |
